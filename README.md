...
5. [Example] execfile('Oph_continuum_LB.v6.py')  in CASA (version 6.5.2 or later) <= Continuum imaging from  *.ms.ave.cont
...
6. [Example] execfile('Oph_spectral_lines_LB.v6.py')  in CASA (version 6.5.2 or later) <= Line imaging
- For imaging of SB or LB data only, simply execute the corresponding script in the Work directory (e.g., Oph_spectral_lines_SB.v6.py for SB, Oph_spectral_lines_LB.v6.py for LB).
