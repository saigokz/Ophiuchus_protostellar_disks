...
# ID Name Chans Ch0(MHz) Wid(kHz) TotBW(kHz) CtrFreq(MHz) 
# 25 BB1-1 3840 218670.1 -488.2  1875000.  217732. [216.795~218.670]  
# 27 BB2-1  960 220392.0  -61.0    58593.  220362. [220.333~220.392] 13CO(2-1)? 
# 29 BB2-2  480 218772.0 -122.0    58593.  218742. [218.713~218.772] H2CO 
# 31 BB2-3  960 219961.5  -61.0    58593.  219932. [219.906~219.961] SO
# 33 BB2-4  960 219572.4  -61.0    58593.  219543. [219.514~219.572] C18O(2-1)
# 35 BB3-1 3840 230073.3  244.1   937500.  230541. [230.073~231.011] 12CO(2-1)  
# 37 BB4-1 3840 233294.3  488.2  1875000.  234231. [233.294~235.169]  
##
# Reduced by
...
## Setting 1: Data Path 
path_SB = './' # Set the SB work directory (e.g., '../Work_SB_XXX/' ).
path_LB = './' # Set the LB work directory (e.g., './' ).
...
image_master_list = {
   ...
   "H2CO_3_03-2_02_218.22GHz":dict(chanstart='-10km/s',chanwidth='1.34km/s',
            nchan=23, linefreq='218.22219200GHz', linespw='25',
            robust=robust,imsize=imsize,cellsize=cellsize,uvtaper=uvtaper),
